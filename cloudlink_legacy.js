...
const vers = 'S2.3'; // Suite version number
...
console.log("[CloudLink Suite] Loaded CloudLink Suite successfully. You are running version "+ vers +".");
console.log("[Legacy Notice] This version of CloudLink is a Legacy release, and should NOT be used in new projects. Please use this version for loading an older project and porting it to CloudLink 3.0");
